...
const EtTrainingDifferent = () => {
  return (
    <section className="et-different-container py-20 lg:py-24 bg-white px-[5%]">
      <div className="max-w-6xl mx-auto">
        {/* Header Row */}
        <div className="mb-10 lg:mb-12 et-different-header">
          <h2 className="text-[clamp(1.8rem,3vw,2.5rem)] font-bold text-text-primary mb-4 lg:mb-6 leading-[1.2]">
            What Makes Our Training Different
          </h2>
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-4 lg:gap-8">
            <p className="text-[1.1rem] text-[#555] leading-[1.8] max-w-3xl">
        ...
        <div className="relative w-full rounded-[1.5rem] lg:rounded-[2rem] overflow-hidden bg-gray-100 min-h-[500px] lg:min-h-[640px] flex items-center justify-end group et-different-image">
          <img
          ...
          {/* Overlaid Card */}
          <div className="relative z-10 bg-white rounded-[1.25rem] p-8 lg:px-12 lg:py-14 w-[90%] lg:w-[460px] mx-auto lg:mx-0 lg:mr-[4%] my-8 lg:my-0 shadow-[0_10px_40px_rgba(0,0,0,0.08)] et-different-card flex flex-col justify-center">
            <div className="flex flex-col gap-10 lg:gap-12">
              {/* Feature 1 */}
              <div>
                <div className="text-green-500 mb-3 flex">
