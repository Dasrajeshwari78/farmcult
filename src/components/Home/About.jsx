...
const About = () => {
  return (
    <section
      className="about-container w-full max-w-[1600px] mx-auto pt-20 md:pt-32 pb-12 md:pb-16 px-4 md:px-[5%] flex flex-col"
      id="why"
    >
      {/* Header Section */}
      <div className="about-header flex flex-col md:flex-row md:justify-between items-start md:items-end mb-8 md:mb-12 gap-6 md:gap-8">
        <div className="about-header-text w-full md:max-w-[700px]">
          ...
          <p className="section-subtitle text-[15px] text-text-secondary leading-[29px] md:leading-[29px]">
            Farmcult uses technology to build farming systems that are easy to
            manage, sustainable, and designed to grow over time.
          </p>
        </div>
