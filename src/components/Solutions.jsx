        ...
        <div className="solutions-cards-wrapper flex flex-col md:flex-row gap-[28px] md:gap-14 justify-between">
          ...
          <div className="solution-card flex-1 gap-24 relative bg-[#ECECEC] bg-cover bg-center rounded-[16px] md:rounded-[20px] h-[337px] md:h-auto md:min-h-[540px] w-full max-w-[370px] md:max-w-none mx-auto md:mx-0 flex flex-col justify-between p-[25px] md:py-10 md:px-8 text-white overflow-hidden transition-transform duration-400 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-2.5 shadow-[0_10px_30px_rgba(0,0,0,0.1)]" style={{ backgroundImage: "linear-gradient(180deg, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.85) 100%), url('/ourSolutionCard1.jpg')" }}>
            ...
            <div className="solution-card-top relative z-10 w-full">
              <h3 className="solution-card-title font-inter text-[24px] md:text-[24px] font-bold leading-[29px] md:leading-[29px] m-0 w-full h-auto">Passive Income Model</h3>
            </div>
          ...
          <div className="solution-card flex-1 gap-24 relative bg-[#ECECEC] bg-cover bg-center rounded-[16px] md:rounded-[20px] h-[337px] md:h-auto md:min-h-[540px] w-full max-w-[370px] md:max-w-none mx-auto md:mx-0 flex flex-col justify-between p-[25px] md:py-10 md:px-8 text-white overflow-hidden transition-transform duration-400 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-2.5 shadow-[0_10px_30px_rgba(0,0,0,0.1)]" style={{ backgroundImage: "linear-gradient(180deg, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.85) 100%), url('/ourSolutionCard2.jpg')" }}>
            <div className="solution-card-overlay hidden"></div>
            <div className="solution-card-top relative z-10 w-full">
              <h3 className="solution-card-title font-inter text-[24px] md:text-[24px] font-bold leading-[29px] md:leading-[29px] m-0 w-[70%] h-auto">Turnkey Solution</h3>
            </div>
            <div className="solution-card-bottom relative z-10 w-full flex flex-col gap-[50px] md:gap-6 justify-end">
              <p className="solution-card-desc font-inter text-[15px] md:text-[15px] font-normal leading-[29px] text-[#F7F7F7] m-0 w-full h-auto">
          ...
          <div className="solution-card flex-1 gap-24 relative bg-[#ECECEC] bg-cover bg-center rounded-[16px] md:rounded-[20px] h-[337px] md:h-auto md:min-h-[540px] w-full max-w-[370px] md:max-w-none mx-auto md:mx-0 flex flex-col justify-between p-[25px] md:py-10 md:px-8 text-white overflow-hidden transition-transform duration-400 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-2.5 shadow-[0_10px_30px_rgba(0,0,0,0.1)]" style={{ backgroundImage: "linear-gradient(180deg, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.85) 100%), url('/ourSolutionCard3.jpg')" }}>
            <div className="solution-card-overlay hidden"></div>
            <div className="solution-card-top relative z-10 w-full">
              <h3 className="solution-card-title font-inter text-[24px] md:text-[24px] font-bold leading-[29px] md:leading-[29px] m-0 w-full h-auto">Education & Training</h3>
            </div>
            <div className="solution-card-bottom relative z-10 w-full flex flex-col gap-[50px] md:gap-6 justify-end">
              <p className="solution-card-desc font-inter text-[15px] md:text-[15px] font-normal leading-[29px] text-[#F7F7F7] m-0 w-full h-auto">
